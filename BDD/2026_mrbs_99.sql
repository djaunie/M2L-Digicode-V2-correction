...
CREATE TABLE IF NOT EXISTS `mrbs_room_digicode` (
  `id` int NOT NULL,
  `digicode` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(5, 2, 'antoineq', 'b89f7a5ff3e3a225d572dac38b2a67f7', 'antoine.quentin@lorraine-sport.net'),
...
(54, 0, 'jeanDeSaintAngel', '$2y$10$C7F.2GGMRdXW08q797oOyeTm4MYTOiVCL', 'desainta.j@lyceedelasalle.fr'),
...
CREATE DEFINER=`root`@`localhost` EVENT `evt_regenerer_digicodes` ON SCHEDULE EVERY 1 WEEK STARTS '2026-05-10 23:00:00' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE `mrbs_room_digicode`
