...
CREATE TABLE IF NOT EXISTS `mrbs_area` (
  ...
  `area_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `area_admin_email` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  ...
  `private_override` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  ...
  `custom_html` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
...
CREATE TABLE IF NOT EXISTS `mrbs_entry` (
  ...
  `create_by` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `name` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `type` char(1) NOT NULL DEFAULT 'E',
  `description` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `status` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `reminded` int DEFAULT NULL,
  `info_time` int DEFAULT NULL,
  `info_user` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `info_text` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `ical_uid` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `ical_sequence` smallint NOT NULL DEFAULT '0',
  `ical_recur_id` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
--
-- Structure de la table `mrbs_parametres`
--

DROP TABLE IF EXISTS `mrbs_parametres`;
CREATE TABLE IF NOT EXISTS `mrbs_parametres` (
...
--
-- Déchargement des données de la table `mrbs_parametres`
--

INSERT INTO `mrbs_parametres` (`cle`, `valeur`) VALUES
('digicode', 'A1B2C3');
...
CREATE TABLE IF NOT EXISTS `mrbs_repeat` (
  ...
  `rep_opt` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `room_id` int NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `mrbs_room` (
  ...
  `room_name` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `sort_key` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `description` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `capacity` int NOT NULL DEFAULT '0',
  `room_admin_email` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  `custom_html` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  PRIMARY KEY (`id`),
...
--
-- Structure de la table `mrbs_room_digicode`
--

DROP TABLE IF EXISTS `mrbs_room_digicode`;
CREATE TABLE IF NOT EXISTS `mrbs_room_digicode` (
  `id` int NOT NULL COMMENT 'Clé étrangère vers mrbs_room.id — PAS d''AUTO_INCREMENT',
  `digicode` varchar(6) NOT NULL COMMENT 'Digicode hexadécimal à 6 caractères (ex: A1B2C3)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Déchargement des données de la table `mrbs_room_digicode`
--
...
CREATE TABLE IF NOT EXISTS `mrbs_users` (
  ...
  `email` varchar(75) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(1, 2, 'admin', '$2y$10$.Hn.HLyUYhwQP64IptJabOfylFlp4xZ.2', 'admin.mrbs@lorraine-sport.net'),
(2, 0, 'cheminl', '$2y$10$41G3.m9Dgvq9Jeg3QPK36uoagVnfZVmtD', 'chemin.lorette@lorraine-sport.net'),
...
CREATE TABLE IF NOT EXISTS `mrbs_variables` (
  `id` int NOT NULL AUTO_INCREMENT,
  `variable_name` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `variable_content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
  PRIMARY KEY (`id`)
...
--
-- Contraintes pour la table `mrbs_room_digicode`
--
ALTER TABLE `mrbs_room_digicode`
  ADD CONSTRAINT `fk_room_digicode` FOREIGN KEY (`id`) REFERENCES `mrbs_room` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
CREATE DEFINER=`root`@`localhost` EVENT `evt_regenerer_digicodes` ON SCHEDULE EVERY 1 WEEK STARTS '2026-05-10 23:30:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    -- Met à jour le digicode de chaque salle avec un nouveau code hexadécimal aléatoire
